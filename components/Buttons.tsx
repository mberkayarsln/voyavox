...
const Buttons = () => {
    ...
    return (
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:justify-between w-full max-w-[800px]">
            <Link href="#demo1" onClick={() => handleDemoStart(setIsPlaying)} className={`w-[300px] sm:w-auto px-5 md:px-12 py-3 md:py-4 whitespace-nowrap rounded-[40px] border-2 border-${isPlaying ? "white" : "navy"} flex flex-row-reverse justify-center gap-4 sm:gap-0 sm:flex-col items-center`}>
            ...
            <Link href="/" className={`w-[300px] sm:w-auto px-5 md:px-12 py-3 md:py-4 whitespace-nowrap rounded-[40px] border-2 border-${isPlaying ? "white" : "navy"} flex flex-row-reverse justify-center gap-4 sm:gap-0 sm:flex-col items-center`}>
                <div className={`text-${isPlaying ? "white" : "navy"} font-bold text-lg sm:text-xl lg:text-2xl text-center`}>
