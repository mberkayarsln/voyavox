...
export default function Home() {
  return (
    <div className="h-screen flex flex-col justify-between pt-44 pb-3 items-center">
      ...
      <div className="flex flex-col items-center gap-10">
        <div className="flex justify-between w-[800px] ">
          ...
          <div className="px-12 py-4 rounded-[40px] border-2 border-navy flex flex-col items-center">
